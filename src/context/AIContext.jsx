...
const PORTFOLIO_TOUR = [
  ...
  { text: "In Test Automation, I use Selenium WebDriver, Robot Framework, and TestNG along with Page Object Model and Maven, using Python and Java to build scalable frameworks.", sectionId: "skills", highlightId: "skill-0" },
  { text: "For API and database testing, I use Postman, REST Assured, and Swagger for APIs, handling JSON and XML. For databases, I write complex SQL queries across PostgreSQL, MongoDB, and Oracle.", sectionId: "skills", highlightId: "skill-1" },
  { text: "My DevOps and tooling stack includes Azure DevOps, continuous integration pipelines, JIRA, Git, Kubernetes, and Linux environments.", sectionId: "skills", highlightId: "skill-2" },
  { text: "My testing approach is rooted in Agile and Scrum methodologies, covering the full SDLC and STLC using BDD. I have extensive experience in functional, regression, API, database, and end-to-end testing.", sectionId: "skills", highlightId: "skill-3" },
